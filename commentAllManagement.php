 ...
 * @LastEditors: Andwxa
 * @LastEditTime: 2022-11-01 15:10:00
...
if ($priority=='selectAId') {
    $allPage = $mysqls_interface->selectCommentPageEightMysql('',$vague,'');
}elseif($priority=='selectUId'){
    $allPage = $mysqls_interface->selectCommentPageEightMysql('','',$vague);
}elseif($priority=='selectCId'){
    $allPage = $mysqls_interface->selectCommentPageEightMysql($vague,'','');
}else{
    $allPage = $mysqls_interface->selectCommentPageEightMysql('','','');
}
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <script>
            $(document).ready(function (){
                ...
                $("#commentAllManagement").addClass("active");
                // 单选按钮
                $a = '<?php echo $priority?>';
                if ($a){
        ...
        <div class="row">
            ...
            <div class="col-xs-9">
                ...
                <form class="form-inline" id="select" method="get" action='commentAllManagement.php'>
                    ...
                    <input type="radio" name="priority" id="selectUId" value="selectUId" /><span>用户</span>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php
                            if ($priority=='selectAId') {
                                ...
                                // 获得所有文章id
                                $aId = $mysqls_interface->selectArticleByUIdMysql();
                            }
                            // 如果有文章id
                            if ($aId) {
                                // 输出文章id
